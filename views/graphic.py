...
class GraphicView:
    def __init__(self, master, controller, model):
        ...
        self.controller.set_view_graphiccontroller(self)
    ...
    def create_images(self):
        self.image_image_1 = PhotoImage(file=self.model.relative_to_assets_graphic("image_1.png"))
        self.image_1 = self.canvas.create_image(823.0, 449.0, image=self.image_image_1)
        self.widgets.append(self.image_1)

    def create_buttons(self):
        self.button_image_1 = PhotoImage(file=self.model.relative_to_assets_graphic("button_1.png"))
        ...
        self.button_1.place(x=349.0, y=316.0, width=449.0, height=179.0)
        self.widgets.append(self.button_1)

        self.button_image_2 = PhotoImage(file=self.model.relative_to_assets_graphic("button_2.png"))
        ...
        self.button_2.place(x=855.0, y=316.0, width=449.0, height=179.0)
        self.widgets.append(self.button_2)

        self.button_image_3 = PhotoImage(file=self.model.relative_to_assets_graphic("button_3.png"))
        ...
        self.button_image_hover_3 = PhotoImage(file=self.model.relative_to_assets_graphic("button_hover_1.png"))
        self.button_3.bind('<Enter>', self.button_3_hover)
        self.button_3.bind('<Leave>', self.button_3_leave)

        self.button_image_4 = PhotoImage(file=self.model.relative_to_assets_graphic("button_4.png"))
        ...
        self.button_image_hover_4 = PhotoImage(file=self.model.relative_to_assets_graphic("button_hover_2.png"))
        self.button_4.bind('<Enter>', self.button_4_hover)
        self.button_4.bind('<Leave>', self.button_4_leave)

        self.button_image_5 = PhotoImage(file=self.model.relative_to_assets_graphic("button_5.png"))
        ...
        self.button_image_hover_5 = PhotoImage(file=self.model.relative_to_assets_graphic("button_hover_3.png"))
        self.button_5.bind('<Enter>', self.button_5_hover)
        self.button_5.bind('<Leave>', self.button_5_leave)

        self.button_image_6 = PhotoImage(file=self.model.relative_to_assets_graphic("button_6.png"))
        ...
        self.button_image_hover_6 = PhotoImage(file=self.model.relative_to_assets_graphic("button_hover_4.png"))
        self.button_6.bind('<Enter>', self.button_6_hover)
        self.button_6.bind('<Leave>', self.button_6_leave)

        self.button_image_7 = PhotoImage(file=self.model.relative_to_assets_graphic("button_7.png"))
        ...
        self.button_image_hover_7 = PhotoImage(file=self.model.relative_to_assets_graphic("button_hover_5.png"))
        self.button_7.bind('<Enter>', self.button_7_hover)
        self.button_7.bind('<Leave>', self.button_7_leave)

    def hide_widgets(self):
        for widget in self.widgets:
            if isinstance(widget, (Canvas, Button)):
                widget.place_forget()
            else:
