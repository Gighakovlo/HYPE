...
class LoginView:
    def __init__(self, master, controller, model):
        ...
        self.controller.set_view_logincontroller(self)


    def create_text(self):
        self.image_image_1 = PhotoImage(file=self.model.relative_to_assets("image_1.png"))
    ...
    def create_images(self):
        self.image_image_2 = PhotoImage(file=self.model.relative_to_assets("image_2.png"))
        self.image_2 = self.canvas.create_image(1258.0, 110.0, image=self.image_image_2)
        self.widgets.append(self.image_2)

    def create_buttons(self):
        self.button_image_1 = PhotoImage(file=self.model.relative_to_assets("button_1.png"))
        ...
        self.button_image_2 = PhotoImage(file=self.model.relative_to_assets("button_2.png"))
        ...
        self.button_image_3 = PhotoImage(file=self.model.relative_to_assets("button_3.png"))
        ...
        self.button_image_hover_3 = PhotoImage(file=self.model.relative_to_assets("button_hover_1.png"))
        self.button_3.bind('<Enter>', self.button_3_hover)
        self.button_3.bind('<Leave>', self.button_3_leave)

        self.button_image_4 = PhotoImage(file=self.model.relative_to_assets("button_4.png"))
        ...
        self.button_image_hover_4 = PhotoImage(file=self.model.relative_to_assets("button_hover_2.png"))
    ...
    def create_entries(self):
        ...
        self.entry_image_1 = PhotoImage(file=self.model.relative_to_assets("entry_1.png"))
        ...
        self.entry_image_2 = PhotoImage(file=self.model.relative_to_assets("entry_2.png"))
