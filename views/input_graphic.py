...
class InputGraphicView:
    def __init__(self, master, controller, model):
        ...
        self.controller.set_view_inputgraphiccontroller(self)
    ...
    def create_images(self):
        self.image_image_1 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("image_1.png"))
        self.image_1 = self.canvas.create_image(823.0, 449.0, image=self.image_image_1)
        self.widgets.append(self.image_1)

        self.image_image_2 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("image_2.png"))
        self.image_2 = self.canvas.create_image(827.0, 381.0, image=self.image_image_2)
        self.widgets.append(self.image_2)

    def create_buttons(self):
        self.button_image_1 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_1.png"))
        ...
        self.button_1.place(x=719.0, y=466.0, width=209.0, height=64.0)
        self.widgets.append(self.button_1)

        self.button_image_2 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_2.png"))
        ...
        self.button_2.place(x=1202.0, y=728.0, width=132.86474609375, height=122.0)
        self.widgets.append(self.button_2)

        self.button_image_3 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_3.png"))
        ...
        self.button_image_hover_3 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_hover_1.png"))
        self.button_3.bind('<Enter>', self.button_3_hover)
        self.button_3.bind('<Leave>', self.button_3_leave)

        self.button_image_4 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_4.png"))
        ...
        self.button_image_hover_4 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_hover_2.png"))
        self.button_4.bind('<Enter>', self.button_4_hover)
        self.button_4.bind('<Leave>', self.button_4_leave)

        self.button_image_5 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_5.png"))
        ...
        self.button_image_hover_5 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_hover_3.png"))
        self.button_5.bind('<Enter>', self.button_5_hover)
        self.button_5.bind('<Leave>', self.button_5_leave)

        self.button_image_6 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_6.png"))
        ...
        self.button_image_hover_6 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_hover_4.png"))
        self.button_6.bind('<Enter>', self.button_6_hover)
        self.button_6.bind('<Leave>', self.button_6_leave)

        self.button_image_7 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_7.png"))
        ...
        self.button_image_hover_7 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("button_hover_5.png"))
        self.button_7.bind('<Enter>', self.button_7_hover)
        self.button_7.bind('<Leave>', self.button_7_leave)

    def create_entries(self):
        self.entry_image_1 = PhotoImage(file=self.model.relative_to_assets_inputgraphic("entry_1.png"))
        self.entry_bg_1 = self.canvas.create_image(826.5, 381.0, image=self.entry_image_1)
        self.entry_1 = Entry(
            self.canvas,
            bd=0,
            bg="#ECE4B7",
        ...
        self.entry_1.place(x=631.0, y=353.0, width=391.0, height=54.0)
